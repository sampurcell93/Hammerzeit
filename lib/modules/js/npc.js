(function() {
  ...
  define(["utilities", "board", "mapper", "underscore", "backbone"], function(ut, board, mapper) {
    ...
    NPC = (function(_super) {
      ...
      NPC.prototype.checkEnterable = function(dx, dy) {
        var chunk, tile, _ref1;
        chunk = mapper.getVisibleChunk().children;
        try {
          tile = (_ref1 = chunk[(this.marker.y + (50 * dy)) / 50]) != null ? _ref1.children[(this.marker.x + (50 * dx)) / 50] : void 0;
          ut.c(tile);
          if (tile.enter === false) {
            return false;
          } else {
