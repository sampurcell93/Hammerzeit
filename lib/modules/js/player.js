  ...
  define("player", ["utilities", "npc", "board", "globals", "mapper", "backbone", "easel", "underscore"], function(ut, NPC, board, globals, mapper) {
    ...
    player = (function(_super) {
      ...
      player.prototype.initialize = function(attrs) {
        var sheet, sprite;
        _.bindAll(this, "contextualize", "afterMove", "insideChunkBounds", "move");
      ...
      player.prototype.afterMove = function(dx, dy) {
      ...
      player.prototype.move = function(dx, dy) {
        return player.__super__.move.call(this, dx, dy, this.afterMove);
      };
