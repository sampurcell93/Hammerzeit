(function() {
  define(["utilities", "globals", "dialog", "npc", "mapper", "player", "jquery"], function(ut, globals, dialog, NPC, mapper, player) {
    return require(["board", "taskrunner"], function(board, taskrunner) {
      var $c, PC, delegate, generalFns, kc, keysdisabled, stateFns,
        _this = this;
      PC = player.PC;
