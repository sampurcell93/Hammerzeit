(function() {
  define(["globals", "utilities", "underscore", "easel", "jquery"], function(globals, ut) {
    var getFromShorthand, loadMap, renderMap, setDefaultTileAttrs, tileheight, tiles, tileurl, tilewidth;
    ...
    renderMap = function(bitmap, stage, vertindex) {
      ...
      return _.each(bitmap, function(tile, i) {
        if ($.isArray(tile)) {
