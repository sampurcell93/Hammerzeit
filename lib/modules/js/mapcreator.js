(function() {
  ...
  define(["globals", "utilities", "mapper", "backbone", "jquery", "underscore"], function(globals, ut, mapper) {
    ...
    OverlayItem = (function(_super) {
      ...
      OverlayItem.prototype.modifyTileInfo = function() {
        ...
        modal.on("keydown", ".js-add-dirs, .js-add-elevation", function(e) {
          ...
          if (key === 13) {
            if (multi) {
              _this.parent.modifyAllTiles(modal);
            }
            return _this.applyChanges(modal);
          }
        });
        return tile;
      };
      ...
      OverlayItem.prototype.applyChanges = function(modal, proceed) {
        ...
        this.model.set("elv", modal.find(".js-add-elevation").val());
        ut.destroyModal();
      ...
      OverlayItem.prototype.events = {
        click: function(e) {
          var model;
          this.$el.toggleClass("selected-tile");
          e.preventDefault();
          if (!e.shiftKey) {
            model = this.model;
            _selected.add(this.model);
            return this.modifyTileInfo();
          } else {
            if (_selected.indexOf(this.model) !== -1) {
              return _selected.remove(this.model.cid);
            } else {
