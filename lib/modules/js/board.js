(function() {
  define(['globals', 'utilities', 'player', 'npc', 'jquery', 'underscore', 'easel'], function(globals, ut, PC, NPC) {
    var $canvas, addState, canvas, clear, initialize, introSlider, keysDisabled, newGame, removeState, scenecount, scenelen, setPresetBackground, setState, stage, startSlideshow, state, states, taskrunner, textshadow, ticker, walkingMan;
