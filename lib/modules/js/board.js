(function() {
  define(['globals', 'utilities', 'player', 'npc', 'jquery', 'underscore', 'easel'], function(globals, ut, PC, NPC) {
    var $canvas, addCharacter, addState, canvas, clear, initialize, introSlider, removeState, scenecount, scenelen, setPresetBackground, setState, stage, startSlideshow, state, states, taskrunner, textshadow, ticker, walkingMan;
