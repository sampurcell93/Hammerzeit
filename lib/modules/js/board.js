(function() {
  define(['globals', 'utilities', 'battler', 'jquery', 'underscore', 'easel'], function(globals, ut, battler) {
    var $canvas, addMarker, addState, board, canvas, clear, flashStateChange, initialize, introSlider, removeState, scenecount, scenelen, setPresetBackground, setState, stage, startSlideshow, state, stateChangeEvents, states, taskrunner, textshadow, ticker, walkingMan,
      _this = this;
