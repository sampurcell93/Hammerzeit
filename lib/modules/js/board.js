(function() {
  define(['globals', 'utilities', 'jquery', 'underscore', 'easel'], function(globals, ut) {
    var $canvas, addMarker, addState, board, canvas, clear, flashStateChange, initialize, introSlider, removeState, scenecount, scenelen, setPresetBackground, setState, stage, startSlideshow, state, stateChangeEvents, states, textshadow, ticker, toggleGrid, walkingMan, _gridded,
      _this = this;
