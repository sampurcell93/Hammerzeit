...
(function() {
  ...
  define(["board", "globals", "utilities", "mapper", "npc", "mapcreator", "player", "cast"], function(board, globals, ut, mapper, NPC, mapcreator, player, cast) {
    var Battle, Dispatcher, Enemy, GridOverlay, GridSquare, InitiativeQueue, NPCArray, PCs, Player, Timer, battle_events, getActive, map, stage, states, _active_chars, _activebattle, _activemap, _grid, _ref, _ref1, _ref2, _ref3, _shared, _sm, _timer, _ts;
    PCs = player.PCs;
    Player = player.model;
    ...
    Dispatcher = (function() {
      ...
      function Dispatcher() {
        var dispatcher, sheet, spritesheet;
        spritesheet = {
          framerate: 100,
          animations: {
            bounce: [0, 7]
          },
          images: ["images/tiles/dispatchers.png"],
        ...
        sheet.getAnimation("bounce").speed = .25;
        sheet.getAnimation("bounce").next = "bounce";
        this.marker = new createjs.Container();
        this.marker.addChild(dispatcher = new createjs.Sprite(sheet, "bounce"));
        this.marker.dispatcher = dispatcher;
        this.marker.x = 100;
        this.marker.y = 500;
        this.marker.regY = 7;
        this.bindEvents();
      ...
      Dispatcher.prototype.showDispatchMenu = function() {
        ...
        return battle_events.trigger("showDispatchMenu", player.PCs);
      };

      Dispatcher.prototype.bindEvents = function() {
        return this.marker.on("click", this.showDispatchMenu, false, this);
      };
    ...
    Battle = (function(_super) {
      ...
      Battle.prototype.dispatcher = new Dispatcher;
      ...
      Battle.prototype.addPCs = function() {
        ...
        return _.each(PCs.models, function(pc, i) {
          return globals.shared_events.trigger("bindmenu", pc);
        });
      };
    ...
    return window.battler = {
      ...
      potentialDispatch: function(character) {
        return _activebattle.dispatcher.addChild(character.marker);
      },
